...
public class faf extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		String sql5 = "select ip  from update_device";
		ResultSet rs3 = conn_combox.executeQuery(sql5);
		try {
			while(rs3.next()){
...
//			java.util.logging.Logger.getLogger(faf.class.getName())
...
//		}
	...
	private  Object[][] getFileInfo(String ip){
		...
		String sql4 = "select file_name,file_size,file_time from test.update_sofilelist where ip = '"+ip+"'";
	...
	public int compareProc(String ip1,String ip2,String file_name){
		int i=0;
		DBConnection conn = new DBConnection();
		String sql1 = " select count(*) from (select * from update_sofilelist where file_name = '"+executeCompare(ip1)+"' and ip = '"+ip1+"') a where a.file_size in (select b.file_size from update_sofilelist b where b.file_name = file_name1 and b.ip = '"+ip2+"')";
