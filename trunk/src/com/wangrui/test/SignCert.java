...
public class SignCert {  
    ...
    private String mKeystore = "D:/keys"; // 密锁库路径  
    private char[] mKeystorePass = "123456".toCharArray();// 密锁库密码  
    private char[] mSignPrivateKeyPass = "123456".toCharArray();// 取得签发者私锁所需的密码  
    private String mSignCertAlias = "Management";// 签发者别名  
    private String mSignedCert = "D:/keys/abnerCA.cer"; // 被签证书  
    private String mNewCert = "D:/keys/Management.cer"; // 签发后的新证书全名  
